...
function ENT:DrawInfo()
	...
	if self.Flip then self.FinishedPos = Pos + self:GetAngles():Up() * 25 + Ang:Up() * self.max.x
	...
	cam.Start3D2D(self.FinishedPos, Ang, 0.15)
		...
		draw.RoundedBox(10, TextWidthName * -1.35, 60, math.Clamp(Health,0,MaxHP) / 2, 20, DamageColorScale)
...
function DrugLabMenu( msg )
    ...
    DrugMenu:SetSize( 500, 400 ) 
    DrugMenu:Center() 
    DrugMenu:SetTitle( "Drug Lab")  
	...
	weed2:SetText(""..Weed.."/30")
	weed2:SetColor( Color(0,255,0,255) )
	weed2:SetSize(60, 20)
	weed2:SetPos(16, 110)
	weed2:SetFont( "Trebuchet24" )
	...
	drugbutton:SetPos( 25, 185 )
	drugbutton:SetText( "Refine Into Drug" )
	drugbutton:SetTextColor( Color(255, 255, 255, 255) )
	drugbutton:SetSize( 110, 25 )
