...
function ENT:Explosion()
	...
	util.BlastDamage(self.Entity, self.Owner, self.Entity:GetPos(), 300, 90)
...
function ENT:PhysicsCollide(data,phys)
	if data.Speed > 50 then
		self.Entity:EmitSound("physics/metal/metal_grenade_impact_hard" .. math.random(1, 3) .. ".wav", 90, math.random(95, 105))
	end
